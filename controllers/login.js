...
// TODO: Properly manage login with middleware and sessions.
// Good example: https://codeshack.io/basic-login-system-nodejs-express-mysql/
...
router.post('/', function(req, res) {
    ...
    (async () => {
        // BINARY makes the statement case-sensitive. This won't matter once proper hashing is implemented.
        ...
        if (user.Type.toLowerCase() == 'artist') { // needs to be here because needs to do math
